...
$this->params['search'] = $this->render('@app/views/layouts/_top-search');
    ...
    <div class="col-md-12">
        <ul class="topstats clearfix">
            ...
            <li class="col-xs-6 col-lg-3">
                <span class="title"><i class="fa fa-dot-circle-o"></i> 论文</span>
                <h3>36<small>篇</small></h3>
                <span class="diff"><b class="color-down"><i class="fa fa-caret-down"></i> 26%</b> from yesterday</span>
            </li>
            <li class="col-xs-6 col-lg-3">
                <span class="title"><i class="fa fa-calendar-o"></i>本月讲座</span>
                <h3>9<small>场</small></h3>
                <span class="diff"><b class="color-up"><i class="fa fa-caret-up"></i> 26%</b> from last week</span>
            </li>

            <li class="col-xs-6 col-lg-3">
                <span class="title"><i class="fa fa-users"></i> 学生</span>
                <h3>960</h3>
                <span class="diff"><b class="color-down"><i class="fa fa-caret-down"></i> 26%</b> from yesterday</span>
            </li>
