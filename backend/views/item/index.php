...
$this->registerJsFile('@web/media/js/table_base.js',[ 'depends'=> 'backend\assets\MetronicAsset']);
?>
<div class="auth-item-model-index">

    <div class ="search-container" >
        <?=Html::a("创建 <i class='icon-plus'></i>" , ['create' ], ['class' => 'btn btn-success green']) ?>
        <form action =<?= Url::to(['item/index']) ?> method="get" class="form-search pull-right" >
