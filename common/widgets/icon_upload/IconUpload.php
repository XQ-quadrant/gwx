 ...
 */
namespace common\widgets\icon_upload;

use Yii;
use yii\widgets\InputWidget;
use yii\helpers\Html;
use yii\web\View;
use common\widgets\icon_upload\assets\IconUploadAsset;
use yii\helpers\ArrayHelper;
use yii\helpers\Url;

class IconUpload extends InputWidget
{
    public $config = [];
    ...
    {
        IconUploadAsset::register($this->view);
